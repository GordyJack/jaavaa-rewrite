...
implements Waterloggable, VoxelShapeUtils {
    ...
    public static final int FULL_POS = 0b11111111;
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext context) {
        ...
        if (existingPosition == FULL_POS || !context.getStack().isOf(this.asItem())) {
            return false;
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return blockState.with(POSITION, newPosition)
                .with(WATERLOGGED, fluidState.getFluid() == Fluids.WATER && newPosition != FULL_POS);
    }
    @Override
    ...
    public boolean hasSidedTransparency(BlockState state) {
        return state.get(POSITION) != FULL_POS;
    }

    //Waterloggable overrides
    @Override
    public boolean canFillWithFluid(@Nullable LivingEntity filler, BlockView world, BlockPos pos, BlockState state, Fluid fluid) {
        return state.get(POSITION) != FULL_POS && Waterloggable.super.canFillWithFluid(filler, world, pos, state, fluid);
    }
    @Override
    ...
    public boolean tryFillWithFluid(WorldAccess world, BlockPos pos, BlockState state, FluidState fluidState) {
        return state.get(POSITION) != FULL_POS && Waterloggable.super.tryFillWithFluid(world, pos, state, fluidState);
    }
