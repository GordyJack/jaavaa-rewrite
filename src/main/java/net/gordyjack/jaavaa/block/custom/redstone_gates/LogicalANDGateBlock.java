...
public class LogicalANDGateBlock extends AbstractAdvancedRedstoneGateBlock{
    //Constants
    private static final MapCodec<LogicalANDGateBlock> CODEC = createCodec(LogicalANDGateBlock::new);
    ...
    //Constructor
    public LogicalANDGateBlock(Settings settings) {
        super(settings);
    ...
    protected int getPower(World world, BlockPos pos, BlockState state) {
        ...
        boolean hasPower = inputPowers[0] > 0 && inputPowers[1] > 0;
