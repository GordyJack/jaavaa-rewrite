...
public class JAAVAAScreenHandlers {
    ...
    public static final ScreenHandlerType<RecyclingScreenHandler> RECYCLING_SCREEN_HANDLER =
            register("recycling_table_screen_handler", RecyclingScreenHandler::new);
