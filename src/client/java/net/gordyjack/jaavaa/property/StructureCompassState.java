...
public class StructureCompassState extends NeedleAngleState {
    public static final MapCodec<StructureCompassState> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                            Codec.BOOL.optionalFieldOf("wobble", true).forGetter(StructureCompassState::hasWobble),
                            StructureCompassState.Target.CODEC.fieldOf("target").forGetter(StructureCompassState::getTarget)
                    )
                    .apply(instance, StructureCompassState::new)
    );
    private final Angler aimedAngler;
    private final Angler aimlessAngler;
    private final StructureCompassState.Target target;
    private final Random random = Random.create();

    public StructureCompassState(boolean wobble, StructureCompassState.Target target) {
        super(wobble);
    ...
    protected StructureCompassState.Target getTarget() {
        return this.target;
    }
    ...
    public enum Target implements StringIdentifiable {
        ...
        public static final Codec<StructureCompassState.Target> CODEC = StringIdentifiable.createCodec(StructureCompassState.Target::values);
